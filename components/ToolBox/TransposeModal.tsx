  ...
  return (
    ...
    >
      <div className="h-full md:h-auto w-full">
        <div className="text-xl bg-white text-gray-900 rounded-lg dark:bg-gray-700 dark:text-white py-6 px-6 lg:px-8 inline-flex flex-wrap w-full gap-3 items-center justify-center shadow-sm shadow-slate-600">
...
const TransposeButton = ({ text, onClick }: { text: string; onClick: any }) => {
  return (
    <button
      onClick={onClick}
      className="w-28 justify-center text-white bg-blue-600 hover:bg-blue-400 focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
    >
      {text}
    </button>
  );
